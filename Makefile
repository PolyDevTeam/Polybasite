...
OBJ= out/Color.o out/Entity.o out/Map.o out/Game.o out/main.o out/Score.o

all: out/Basite.o out/Bot.o out/Color.o out/Entity.o out/Map.o out/Game.o out/main.o out/Score.o
